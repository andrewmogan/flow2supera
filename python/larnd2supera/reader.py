...
class InputReader:
    ...
    def ReadFile(self,input_files,verbose=False):
        ...
        # create mapping
        self._packet2event = EventParser.packet_to_eventid(self._mc_packets_assn, self._tracks, ifspill=True)
        ...
        ### TODO larpix_readout_parser's get_t0 has been updated...what checks are
        # necesary now? ###
    ...
    def GetEntry(self,index):
        ...
        mask = self._tracks['spillID'] == result.event_id
